...
public class RentACatIntegrationTest {
	...
	public void testRenameNumCat3() {
		...
		boolean result = r.renameCat(2, "Garfield");
		assertTrue(result);
		// Check that c2 was actually renamed
	...
	public void testRentCatFailureNumCats3() {
		...
		boolean result = r.rentCat(2);
		assertFalse(result);
		assertTrue(c2.getRented()); // Should still be rented
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue(result);
		assertFalse(c2.getRented()); // Should no longer be rented
	...
	public void testReturnFailureCatNumCats3() {
		...
		// c2 is not rented (default state)
		boolean result = r.returnCat(2);
		assertFalse(result);
		assertFalse(c2.getRented()); // Should still not be rented
