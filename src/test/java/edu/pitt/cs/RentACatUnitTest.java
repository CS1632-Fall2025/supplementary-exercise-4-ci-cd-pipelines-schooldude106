...
public class RentACatUnitTest {
	...
	public void testRenameFailureNumCats0() {
		...
		assertFalse(result);
		assertEquals("Invalid cat ID." + newline, out.toString());
		// Verify that no renameCat was called on any mock since no cats exist
	...
	public void testRenameNumCat3() {
		...
		boolean result = r.renameCat(2, "Garfield");
		assertTrue(result);
		// Verify that renameCat was called on c2 with "Garfield"
	...
	public void testRentCatFailureNumCats3() {
		...
		// Set up c2 to be already rented
		when(c2.getRented()).thenReturn(true);
		
		boolean result = r.rentCat(2);
		assertFalse(result);
		verify(c2, never()).rentCat(); // Should not be called since cat is already rented
	...
	public void testReturnFailureCatNumCats3() {
		...
		// c2 is not rented (default mock behavior)
		boolean result = r.returnCat(2);
		assertFalse(result);
		verify(c2, never()).returnCat(); // Should not be called since cat is not rented
