...
public class IntegerOpsTest {
	...
	public void testAdd(@InRange(min = "0") int x, @InRange(min = "0") int y) {
		/*
		 ...
		 */
		 ...
		 assertTrue("Result should be >= 0 when adding two non-negative integers", result >= 0);
	}
	...
	public void testSubtract(int x, int y) {
		 ...
		 */
		 ...
		 int result = IntegerOps.subtract(x, y);
		 assertTrue("Result should be >= 0 when x >= y", result >= 0);
	}
